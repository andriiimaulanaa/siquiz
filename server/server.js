...
const Tesdatabase = mongoose.model('user', {
    ...
    deskripsi: String, 
    npm: String   // Field deskripsi dengan tipe data String
});
...
app.post('/api/data', async (req, res) => {
    const { nama, deskripsi, npm } = req.body;  // Mengambil data dari request body
    const newData = new Tesdatabase({ nama, deskripsi, npm });  // Membuat instance baru dari model Tesdatabase
